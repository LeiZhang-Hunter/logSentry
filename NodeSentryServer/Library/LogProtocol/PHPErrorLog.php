            ...
            if($dataUnit) {
                ...
                foreach (PHPErrorLog::$php_error as $error_key=>$error_value)
                {
                    ...
                    if(strpos($dataUnit,($error_value)) !== false)
                    {
                        ...
                        if(!$position)
                        {
                            self::$logger->trace(Logger::LOG_WARING,"PHPErrorLog","parse","get time end ] error;content :".$dataUnit);
                            break;
                        }
                        ...
                        if(!$main_body)
                        {
                            self::$logger->trace(Logger::LOG_WARING,"PHPErrorLog","parse","get main body  error;content :".$dataUnit);
                            break;
                        }
