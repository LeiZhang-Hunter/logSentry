...
<div class="wrapper">
    ...
    <div class="content-wrapper scroll_bar">
        <div class="content">
            <ol class="breadcrumb">
                <li><a href="javascript:;"><i class="icon-tools"></i> 管理</a></li>
                <li class="active">服务列表</li>
            </ol>
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h5 class="box-title">服务列表)</h5>
                    <div class="box-tools">
                        <div class="has-feedback">
                            <a href="<?=base_url("/Admin/Project/add")?>" class="btn btn-primary btn-sm"><i class="icon-circle"></i> 添加服务</a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
...
<!--                        </form>-->
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <?php foreach ($list as $key=>$value){ ?>
                                <tr>
                                    ...
                                    <td><a href="javascript:;" title="ip地址"><?=$value["client_ip"]?></a> </td>
                                    <td class="text-center"><a href="javascript:;" title="项目名称"><?=$value["project_name"]?></a> </td>
                                    <td class="text-center"><a href="javascript:;" title="项目类型"><?=$value["project_name"]?></a> </td>
                                    <td class="text-center"><a href="javascript:;" title="负责人"><?=$value["true_name"]?></a> </td>
                                    <td class="text-center">
                                        <a href="<?=base_url("/Admin/Project/add?id=".$value["id"])?>" class="btn btn-success btn-sm"><i class="icon-tools"></i> 修改</a>
                                        <a href="<?=base_url("/Admin/LogList/logCollect?project_id=".$value["id"])?>" class="btn btn-primary btn-sm"><i class="icon-circle"></i> 查看项目日志</a>
                ...
                <div class="box-footer clearfix">
                    <!-- Check all button -->
                    <a href="javascript:;" class="btn btn-sm checkbox-toggle"><i class="picon-check-empty"></i> 全选</a>
