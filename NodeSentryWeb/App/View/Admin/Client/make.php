...
<script type="text/javascript">
    ...
    $("#save").click(function(){
        ...
        if(!/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.test(data.sentry_ip))
        {
            $.waring("客户机Ip地址输入不合法");
            return false;
        }
    ...
    configObject.initJsonEditor('jsoneditor',<?=isset($info["config"]) ? $info["config"] : "{}"?>);
</script>
<!-- AdminLTE App -->
</body>
</html>
